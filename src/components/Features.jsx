    ...
    <div className={`${styles.section} ${styles.bgPrimary} banner03`}>
      <div className={`${styles.subSection} flex-col text-center`}>
        ...
        <div className={styles.flexWrap}>
          <FeatureCard iconUrl={assets.react} iconText="Quantitative Test" gameStartHandler={startTheGame} />
          <FeatureCard iconUrl={assets.javascript} iconText="Verbal Test" gameStartHandler={startTheVerbalGame}/> 
        </div>
      </div>
    </div>
  )
